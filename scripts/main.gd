...
func switch_scene(scene_name: String, npc_name: String = "", difficulty: int = 0, npc_portrait: Texture2D = null):
	match scene_name:
		"nostra":
			nostra_active = true
			...
			nostra_instance.start_nostra(npc_name, difficulty, npc_portrait)
